...
<footer class="bg-gray-900 text-white ">
    ...
    <div class="max-w-7xl  px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-20 ">
            ...
            <!-- Company Info -->
            <div class="space-y-4">
                <h2 class="text-2xl font-bold text-white mb-4">The White Palace</h2>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="#" class="text-gray-300 hover:text-white hover:pl-2 transition-all duration-300 flex items-center">
                            <i class="fa-solid fa-bed text-sm mr-2 text-blue-400"></i>
                            Room Booking
                        </a>
                    </li>
                    <li>
                        <a href="#" class="text-gray-300 hover:text-white hover:pl-2 transition-all duration-300 flex items-center">
                            <i class="fa-solid fa-utensils text-sm mr-2 text-blue-400"></i>
                            Restaurant
                        </a>
                    </li>
                    <li>
                        <a href="#" class="text-gray-300 hover:text-white hover:pl-2 transition-all duration-300 flex items-center">
                            <i class="fa-solid fa-car text-sm mr-2 text-blue-400"></i>
                            Transport
                        </a>
                    </li>
                    <li>
                        <a href="#" class="text-gray-300 hover:text-white hover:pl-2 transition-all duration-300 flex items-center">
                            <i class="fa-solid fa-spa text-sm mr-2 text-blue-400"></i>
                            Spa & Wellness
                        </a>
                    </li>
                    <li>
                        <a href="#" class="text-gray-300 hover:text-white hover:pl-2 transition-all duration-300 flex items-center">
                            <i class="fa-solid fa-calendar-days text-sm mr-2 text-blue-400"></i>
                            Event Booking
                        </a>
                    </li>
                </ul>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div class="text-center md:text-left">
                    <p class="text-gray-400 text-sm">
                        © 2025 The White Palace. All rights reserved. 
                        <span class="text-green-400">saqlinezaman</span>
                    </p>
                </div>
