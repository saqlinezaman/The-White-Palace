...
<section class="my-10 mx-3 md:mx-16">
    ...
    <div class="overflow-x-auto">
       <div class="d-flex justify-content-between align-items-center mb-4">
         ...
         <a href="add_rooms.php" class="btn btn-info rounded-0 text-white">Add Room</a>
       </div>
                ...
                <?php foreach($rooms as $room): ?>
                    <tr>
                        ...
                        <td class="flex gap-2">
                            ...
                            <a href="delete_room.php?id=<?= $room['id'] ?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
